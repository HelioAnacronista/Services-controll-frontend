         ...
         <ContentFrom>
            <div className='card-from'>
               <div className='details-card-work style-card-details'>
                  <div>
                     <h4> <span>Nome do serviço:</span> {work.name}</h4>
                  </div>
                  <div>
                     <h4 style={{ color: retornaStatus(work.status).color }}> 
                     <span>Status: </span> {retornaStatus(Number(work.status)).name}</h4>

                     
                  </div>
                  <div>
                     <h4> <span>Valor: </span> R${work.valor?.toFixed(2)}</h4>
               ...
               <div className='details-card-cliet style-card-details'>
                  <div>
                     <h4> <span>Nome do cliente: </span> {work.client.name}</h4>
                     
                  </div>
                  <div>
                     <h4><span>Telefone: </span> {work.client.phone}</h4>
                     
                  </div>
                  <div>
                     <h4> <span>Endereço: </span> {work.client.address}</h4>
               ...
               <div className='details-card-category style-card-details'>
                  <div>
                     <h4> <span>Nome da categoria</span> {work.category.name}</h4>
                     
                  </div>
                  <div>
                     <h4> <span>descriçao da categoria: </span> {work.category.description}</h4>
