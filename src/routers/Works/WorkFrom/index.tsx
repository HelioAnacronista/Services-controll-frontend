...
function WorkFrom() {
   ...
   useEffect(() => {
      categoryServices.getListRequest()
         .then(res => {
   ...
   useEffect(() => {
      if (isEditing) {
         workServices.findById(Number(params.workId))
            .then(res => {
   ...
   function handleSubmit(event: any) {
      ...
      const request = isEditing ?
         workServices.updateRequest(requstBody) : workServices.insertRequest(requstBody);
   ...
   return (
      ...
      <>
         <div className='mt-30 card-create title-details'>
            <h1> <span>Workspace de Serviços</span> </h1>
         </div>
